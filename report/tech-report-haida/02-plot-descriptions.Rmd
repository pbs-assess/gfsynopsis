...
standardized with a spatiotemporal model (Appendix \@ref(app:cpue)) and predicted for grid cells within `r roi`, indicated as "Whole area".
...
`r sp` because the hook-and-line panel is mostly blank for `r sp`). The `r roi` polygon is outlined in black. Lighter shading indicates higher levels of a geometric mean of catch per
