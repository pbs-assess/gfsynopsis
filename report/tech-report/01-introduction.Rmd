...
This version of the report is largely unchanged from the last technical report covering data up to 2022.
One change is that the data for the IPHC spatiotemporal model index is now derived directly from the [IPHC website](https://www.iphc.int/data/fiss-survey-raw-survey-data/).
