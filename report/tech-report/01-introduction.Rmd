...
We provide details on this new data processing in Appendix \@ref(app:iphc).

* We removed recreational and unknown sectors from the commercial biological samples.

* We updated the species name "North Pacific Spiny Dogfish" to "Pacific Spiny Dogfish" in accordance with the latest American Fisheries Society recommendation.
