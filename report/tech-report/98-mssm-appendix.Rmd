...
Between 1975 and 1977 there was a noticeable shift of sampling locations relative to subsequent years. It is possible that this reflects surveys where they were establishing of the extents of the shrimping grounds. Although the MSSM is a fixed station survey (Rutherford et al. in prep), over the years, the extent of the survey has decreased \@ref(fig:historical-grid). However, in 2021 and 2022 sampling extended more eastward and northward to cover the original extent better than any year since 1975 \@ref(fig:spatial-shift).


```{r historical-grid, fig.cap="Grid coverage based on year since a grid cell was last sampled. Years also correspond to changes in navigation systems or site selection protocols.", out.width="50%"}
