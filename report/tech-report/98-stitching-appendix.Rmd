...
We used spatiotemporal models both to standardize individual surveys and/or to combine or "stitch" related surveys into BC coastwide or survey-wide indices of abundance or biomass.
...
We apply the same approach for the MSSM WCVI survey and the IPHC FISS given changes to the sampling domain in both cases necessitate a similar (autoregressive) model.
