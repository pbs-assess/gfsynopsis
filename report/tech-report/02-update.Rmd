...
In this Science Response, all figure pages were rebuilt with updated data using the methods described in @anderson2019synopsis and @anderson2020fisheries. 

Survey and commercial data from 2022 were added and we now display length and age composition data for the Inside HBLL survey.

Three species have been added to the report: Eulachon (*Thaleichthys pacificus*), Popeye (*Coryphaenoides cinereus*), and Shortbelly Rockfish (*Sebastes jordani*).
Additionally, data from the Multispecies Small-mesh Bottom Trawl Survey (MSSM) are now included (Rutherford et al. in prep TODO) in the biomass indices and length composition data.

A notable update to this report compared to the 2022 Science Response is the addition of model-based biomass indices. This approach was originally described in @anderson2019synopsis (Appendix E and F).
