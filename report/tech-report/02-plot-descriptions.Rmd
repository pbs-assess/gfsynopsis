...
```{r load-example-figs}
g <- readRDS(here::here("ggplot-objects/petrale-sole.rds"))
sp <- "Petrale Sole"
```
...
dat_survey_index <- readRDS(here::here("../data-cache-aug-2023/canary-rockfish.rds"))
...
g_alt <- list()
g_alt$cpue_spatial <- readRDS(here::here("ggplot-objects/pacific-cod-cpue-spatial.rds"))
g_alt$cpue_spatial_ll <- readRDS(here::here("ggplot-objects/pacific-cod-cpue-spatial-ll.rds"))
