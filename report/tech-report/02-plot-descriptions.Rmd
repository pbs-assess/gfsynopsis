...
When both types of indices are shown, they are scaled to have the same geometric mean and the axes are set to show the model-based confidence intervals.
