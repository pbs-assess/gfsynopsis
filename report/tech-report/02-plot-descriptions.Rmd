...
<!-- TODO: update: -->
- indices scaled to maximum CI
- if two indices are shown on one panel (e.g., modelled and design based), the modelled biomass index is scaled to the maximum CI, and then the design based index is scaled to geometric mean of the max-CI scaled modelled index.
