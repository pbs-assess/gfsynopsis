...
Time series with a solid trend line and shaded ribbon for 95% confidence intervals represent an index that has been standardized with a spatiotemporal model (see Appendix A) \@ref(app:stitching).
...
D in @anderson2019synopsis]. The line itself represents the estimaπte and the shaded
