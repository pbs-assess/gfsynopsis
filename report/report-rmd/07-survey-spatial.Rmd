...
describes the covariance between spatial locations $s_j$ and $s_k$ ($\Phi
\left( s_j, s_k \right)$) as:
...
matrix can be calculated [@latimer2009]. Higher numbers of knots result in a better
