...
We constrain the spatial random effects to follow a \mbox{Mat\'ern} covariance function, which simply defines the shape with which spatial correlation decays with distance. The \mbox{Mat\'ern} function describes the covariance between spatial locations $s_j$ and $s_k$ as:
