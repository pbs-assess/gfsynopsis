...
for groundfish [@thorson2015]. Our specific model is implemented with TMB
[@kristensen2016] and INLA [@rue2009; @lindgren2015] in R [@r2018] via the
R package sdmTMB, which we wrote for this purpose (Appendix \@ref(app:reproducibility)).
...
parameter. The symbol $\bm{X_s}$ represents a vector of predictors (here
