...
available in the gfiphc package [@edwards2022gfiphc].
...
1. In 2018 there were 131 new expansion stations that had not been previously
   ...
   the time-series calculations; they were inadvertently included
...
3. The bootstrapping methods use 10000 bootstrap samples instead of 1000, since
   the results had not stabilized by 1000 samples for some species.
...
Further technical details are given in @edwards2022gfiphc, which also includes
details for analyzing data for individual species, groups of species, and
restricted areas.
