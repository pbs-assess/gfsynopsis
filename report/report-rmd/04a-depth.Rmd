...
# DEPTH-DENSITY RELATIONSHIPS FOR THE SYNOPTIC SURVEYS {#sec:depth-curves}
...
\@ref(sec:spatial-modeling) for details on the models underlying these
predictions.

```{r sdmTMB-depth-all-plots1, fig.width=10, fig.asp=1.15, out.width="\\textwidth", fig.cap="(ref:depth-relationship1)", fig.pos="H"}
