...
<!-- TODO: Add a bit about spatiotemporal index standardization and future work. Mention it is essentially the same model as the spatial model reviewed here. -->
...
```{r sdmTMB-spt-spde, fig.cap='SPDE approximation mesh. Red dots represent the not locations and open black circles represent the location of the survey sets. Survey data across all years is shown in the same panel here.', fig.width=9, out.width="3.7in"}
...
```{r sdmTMB-spt-plot-all-effects-log, fig.width=8, fig.cap='Predictions from geostatistical spatiotemporal model for Pacific Cod in Queen Charlotte Sound. Predicted biomass is shown with a log distributed colour scale.'}
...
```{r sdmTMB-spt-plot-all-effects-sqrt, fig.width=8, fig.cap='Predictions from geostatistical spatiotemporal model for Pacific Cod in Queen Charlotte Sound. Predicted biomass is shown with a square root distributed colour scale.'}
plot_map_spt(predictions$data, "exp(est)") +
  ggtitle("Prediction (fixed effects + all random effects)") +
...
```{r sdmTMB-spt-plot-all-effects-sqrt-depth, fig.width=8, fig.cap='Predictions from geostatistical spatiotemporal model that includes the effects of depth and depth squared for Pacific Cod in Queen Charlotte Sound. Predicted biomass is shown with a square root distributed colour scale.'}
...
```{r plot-index, fig.cap='Relative biomass index predictions from the design based approach, the geostatistical approach without covariance, and the geostatistical approach with depth covariates. Note the similarity between the two geostatistical models.'}
