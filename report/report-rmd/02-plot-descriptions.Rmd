...
p1 <- g$survey_spatial_syn +
  ...
  (if(french){
    ggtitle("Biomasse du relevé synoptique")
  }
else{
  ggtitle("Synoptic Survey Biomass")
  })
...
p2 <- g$survey_spatial_hbll +
  ...
  guides(fill = guide_colorbar(), size = FALSE) +
  (if(french){
    ggtitle("Biomasse du relevé HBLL OUT")
  }
else{
  ggtitle("HBLL OUT survey biomass")
  })
...
p3 <- g$survey_spatial_iphc +
  ...
  (if(french){
    ggtitle("Taux de capture du IPHC")
  }
else{
