...
by searching for 'groundfish synoptic' or 'HBLL'. Requests for data held by the
...
<`r paste0("https://github.com/pbs-assess/gfdata/tree/", sha$gfdata)`>\
<`r paste0("https://github.com/pbs-assess/gfplot/tree/", sha$gfplot)`>\
<`r paste0("https://github.com/pbs-assess/gfiphc/tree/", sha$gfiphc)`>\
<`r paste0("https://github.com/pbs-assess/gfsynopsis/tree/", sha$gfsynopsis)`>\
<`r paste0("https://github.com/pbs-assess/sdmTMB/tree/", sha$sdmTMB)`>\
<`r paste0("https://github.com/pbs-assess/csasdown/tree/", sha$csasdown)`>\

https://github.com/pbs-assess/gfplot/tree/838f89
...
It is intended that this report will continue to (1) facilitate regular review by groundfish scientists and managers of trends in survey indices and stock composition across all species, (2) facilitate generating standardized datasets and biological model fits to help assessment scientists, (3) and increase data transparency between DFO, the fishing industry, First Nations, non-governmental organizations, and the general public.
