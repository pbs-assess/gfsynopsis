...
TODO Details of which years have been added.
...
Data from the Synoptic Bottom Trawl Surveys and the outside-water HBLL surveys are available through the [Open Government Data Portal](https://open.canada.ca/data/en/dataset?portal_type=dataset). 
Requests for data held by the DFO Pacific Region that are not available through the Open Government Data Portal, can be made through 
...
The authors intend to publish approximately biennial updates of this synopsis report. 
These updates will include another two years of data and any important corrections to the data, text, or visualizations. 
