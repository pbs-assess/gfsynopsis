...
from spreadsheets are now all included in our gfiphc R package.
...
for 2003-2012 and 2014-2018. Thus, for 1995 and 1996 we cannot calculate catch rates
based on the first 20&nbsp;hooks (because we only have set-by-set level data),
whereas we can do that for 2003-2012 and 2014-2018, and the 20-hook data is the only
...
\hline
First 20 hooks from each skate & {\bf A}(22) & {\bf D}(19)\\
All hooks from each skate & {\bf B}(17) & {\bf C}(15)\\
\hline
...
**Series A** -- 1997-2018 stations north of WCVI, with catch rates based on
first 20&nbsp;hooks only (which is all we have for 1997-2002 and 2013).

**Series B** -- 1995, 1996, 2003-2012 and 2014-2018 stations north of WCVI, with
catch rates based on all hooks (which is all we have for 1995 and 1996).

**Series C** -- 2003-2012 and 2014-2018 stations coastwide (including WCVI), with
catch rates based on all hooks.

**Series D** -- 1999 and 2001-2018 stations coastwide (including WCVI), with
...
from Series B, based on all hooks, with the 1997-2018 values from Series A that
...
description and usability codes described in Tables\ \@ref(tab:iphc-hook-codes)
and \@ref(tab:iphc-set-codes). In particular,
...
hooks) to the 1997-2018 data from Series&nbsp;A.
...
```{r iphc-hook-with-bait, warning=FALSE, width=5, height=6, fig.cap="Histograms of number of hooks returned with bait in each set for each year in which all hooks were enumerated.", fig.pos="tbp"}
