...
$N_{its}^{(0)}$ is proportional to the true local density, $D_{its}$, and so
is what we wish to use as an index of abundance.

The ies $i$ in year $t$, $F_{it}$ is also
proportional to $D_{it}$.
