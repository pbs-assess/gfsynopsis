...
hook-tally sheet got blown overboard for station 2113 in the year 2008).
Stations that were declared TODO-check-name 
'unusable for spatiotemporal analysis' are more common and are included.

<!--
```{r iphc-hook-codes, tab.cap="Description of hook observation classifications and corresponding codes in theGFBio database."}
