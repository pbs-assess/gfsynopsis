...
scale ranges from zero to the highest value in the maps on each page. The
...
catch-per-unit-effort maps for Pacific Cod (note this figure is **not** `r
sp`). Lighter shading indicates higher levels of a geometric mean of catch per
