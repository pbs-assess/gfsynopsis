...
Station groundfish dock assessments. We calculated the trawl and longline survey
...
We can look at the individual components of the model. For the models without fixed effect predictors for depth, the fixed effect predictions each year are constant spatially (Figure \@ref(fig:sdmTMB-spt-plot-fix-defects)).
