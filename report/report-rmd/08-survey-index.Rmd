...
other_surveys <- run_sql("GFBioSQL", q)
```

\clearpage

```{r other-surveys-table, results='asis'}
csasdown::csas_table(other_surveys, caption = "Other surveys conducted by DFO that are not included in this report but may be applicable for some species-specific analyses.")
```
