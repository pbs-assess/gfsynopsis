...
```{r sdmTMB-plot-index, fig.cap='Relative biomass index predictions from the design based approach, the geostatistical approach without covariates, and the geostatistical approach with depth covariates. Note the similarity between the two geostatistical models.'}
