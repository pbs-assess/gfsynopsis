...
Nonetheless, we have included the relevant equations below for clarity. We also present geostatistical model based estimates of biomass index trends for the trawl surveys for comparison Section (\@ref(#sec:geostatistical)).
...
Details on the design-based estimation of biomass density index for the IPHC survey are shown in Section (TODO).
