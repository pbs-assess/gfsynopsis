...
The synopsis report is comprised of two-page species-by-species subsections
that visually synthesize most available data for each species. See  
\@ref(sec:data) for thorough documentation of how and what data were extracted. 
The report focuses on the 110 species listed in the current BC groundfish 
strategic plan, and focuses on the surveys and data types applicable to the 
widest array of these fish stocks. The report includes 30 'A-level' species, 
which are identified as the main species of commercial and conservation 
interest followed by 80 'B-level' species.
...
Independent Setline surveys (Fig. \@ref(fig:intro-maps)) 
...
a bibliography including all references listed on the figure pages themselves
...
viewed at once. We also note that the table of contents, alphabetized species 
lists and references are clickable hyperlinks to facilitate navigation.
...
conclusions about the status of a stock. Second, biomass indices
...
either because of high survey variability or because only a small fraction
of trawl or longline sets containing the species, but this is not a
...
consideration and analysis. Fluctuations in commercial catch, specifically 
