...
abundance for a variety of reasons --- changes through time, including fish
behavioural changes or range shifts, could also result in biases through time.

Commercial catch per unit effort timeseries, even when
...
structure or content of the report. We will consider these larger
...
First Nations, and non-governmental organizations, which has made the
collection of the valuable data that underlies this report possible. We thank
...
the PBSmapping and PBSdata R packages.
