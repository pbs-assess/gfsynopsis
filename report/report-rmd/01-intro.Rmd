...
spatial and taxonomic coverage of the species in this report. As an example, we
...
```{r closures-map, fig.cap="Map of fishery restriction initiatives in the Pacific Region (MPA = Marine Protected Area). These areas have different restrictions specific to their respective objectives; seasonal fishery closures are not shown here", out.width="3.3in", fig.pos="tb"}
knitr::include_graphics("figure/fishery-closures.png", dpi = NA)
```
...
further details on these package and on the computational environment needed to
...
possibly as a Science Response document. These annual updates will include
