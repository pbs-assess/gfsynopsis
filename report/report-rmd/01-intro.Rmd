...
```{r closures-map, fig.cap="Map of fishery restriction initiatives in the Pacific Region (MPA = Marine Protected Area). These areas have different restrictions specific to their respective objectives; seasonal fishery closures are not shown here", out.width="4.5in", fig.pos="tb"}
