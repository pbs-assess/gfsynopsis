...
```{r closures-map, fig.cap="Map of fishery restriction initiatives in the Pacific Region (MPA = Marine Protected Area). These areas have different restrictions specific to their respective objectives.", out.width="3.3in", fig.pos="tb"}
