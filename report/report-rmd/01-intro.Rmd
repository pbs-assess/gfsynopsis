...
```{r closures-map, fig.cap="Map of fishery restriction initiatives in the Pacific Region (MPA = Marine Protected Area). These areas have restrictions specific to their respective objectives. Seasonal fishery closures are not shown here.", out.width="4.5in", fig.pos="tb"}
