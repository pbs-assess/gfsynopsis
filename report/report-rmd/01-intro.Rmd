...
Inside Hard Bottom Long Line (HBLL) survyes, the Outside HBLL surveys (alternatively 
referred to as the Pacific Halibut Management Association, PHMA, surveys) (Figure
\@ref(fig:intro-maps)), the International Pacific Halibut Commission (IPHC)
Fishery Independent Setline surveys and the Hecate Strait Multispecies Assemblage 
(HS MSA) survey because these provide the greatest
