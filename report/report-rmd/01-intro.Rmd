...
3. Appendix \@ref(sec:cpue-models) provides details on the CPUE
model that underlies the CPUE visualizations.
...
catch per unit effort indices need careful interpretation on a stock-by-stock
