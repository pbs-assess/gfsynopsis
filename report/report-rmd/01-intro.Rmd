...
and data types applicable to the widest array of species.
...
\@ref(fig:management-map)) samples for various biological measurements. Details
of the figures are fully described in Section\ \@ref(sec:plot-descriptions).
...
1. Appendix \@ref(app:depth-curves) shows the predicted relationships between
   depth and synoptic survey biomass density.
...
particularly for species with little data.
