...
Appendix\ \@ref(app:survey-trend-models) along with associated references for
...
1. Appendix \@ref(app:age-precision) shows ageing precision plots.

1. Appendix \@ref(app:depth-curves) shows the predict relationships between
...
1. Appendix \@ref(app:growth-and-maturity) provides details on modeling
   biological parameters.

1. Appendix \@ref(app:reproducibility) discusses the computational environment
