...
```{r aging-method-table-setup, eval=FALSE}
...
```{r aging-method-table, results='asis', eval=FALSE}
...
```{r maturity-table, results='asis', eval=FALSE}
...
```{r spp-cat, results='asis', eval=FALSE}
...
```{r samp-source, results='asis', eval=FALSE}
