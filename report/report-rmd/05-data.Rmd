...
database. Additional historic commercial sales slips records may exist from the 
Halibut, Sablefish and Dogfish-Lingcod fisheries in the PacHarv3 
database. These data require more detailed analysis for inclusion in catch 
reconstructions.
...
start and end dates (Table \@ref(tab:sql-cpue-index)) which include set start and 
end time and are later used to calculate effort (expressed in hours). Catch 
(kg), year, gear type and Pacific Fishery Management Area
...
trawl sector with positive tows since 2012 when the trawl footprint was 
implemented (Table \@ref(tab:sql-cpue-spatial)).
