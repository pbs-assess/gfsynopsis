...
make_pages(dat, "pacific ocean perch", include_map_square = FALSE)
make_pages(dat, "pacific cod")
make_pages(dat, "redbanded rockfish")
make_pages(dat, "yelloweye rockfish")
