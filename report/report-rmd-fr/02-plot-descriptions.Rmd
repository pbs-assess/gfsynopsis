...
g_alt <- readRDS(here::here("report", ifelse(french, "report-rmd-fr", "report-rmd"), "ggplot-objects", "pacific-cod.rds"))
trans <- "fourth_root_power"
