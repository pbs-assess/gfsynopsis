...
if(french){
  spp$species_common_name <-  gfsynopsis:::first_cap(spp$species_common_name)
  ...
  spp$species_common_name <- en2fr(spp$species_common_name, french)
}
