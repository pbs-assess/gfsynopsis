...
\title[International Pacific Halibut Commission Survey]{~\\ International Pacific Halibut Commission Survey}
...
\subtitle{\small CSAP review meeting of Reproducible Data Synopsis.\\
...
%\section{Outline}
%\subsection{}
\frame{\frametitle{Survey background}
\bi
  \item annual stock assessment longline survey, California to Alaska
  \item main aim is data for Pacific Halibut assessment
  \item  each station has a set of up to 8 skates
  \item  each skate has about 100 hooks
  \pause
  \item  count of a species on each set is standardised by that set's  `effective skate number'
  \item `effective skate number' of 1 represents a skate of 100 circle hooks with 18-foot spacing
  \item resulting index has units of `numbers per effective skate'
  % \textcolor{red}
\ei
}
...
\frame{\frametitle{Have to account for changes in available data}
...
\frame{\frametitle{Bait experiment in 2012}
%\begin{minipage}{6cm}
\includegraphics[width=10cm]{images/bait-experiment.png}
%\end{minipage}

We use only chum-bait skates.\\
Figure from Webster et al. talk ``Coastwide bait comparison study''.
% http://www.iphc.int/meetings/2013am/documents/D2P02BaitComp_AM_web.pdf

}
%----------------------------------------------------------

% Now using map figures just copied in from YYR assessment - point is
%  to show changing coverage of survey. See deleted text for first
%  attempt at doing properly in gfsynopsis (no time now).
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/stations1995mapA.png}
}
%----------------------------------------------------------
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/stations1996mapA.png}
}
%----------------------------------------------------------
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/stations1997mapAkeep.png}
}
%----------------------------------------------------------
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/stations1998mapAkeep.png}
}
%----------------------------------------------------------
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/stations1999mapAkeep.png}
}
%----------------------------------------------------------
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/stations2000mapAkeep.png}
}
%----------------------------------------------------------
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/stations2001mapAkeep.png}
}
%----------------------------------------------------------
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/stations2002mapAkeep.png}
}
%----------------------------------------------------------
\frame{\frametitle{Coverage of survey}
\includegraphics[width=7cm, center]{images/allBlocks0314map.png}
}
%----------------------------------------------------------
...
\onefig{stations1996mapA}{Locations of the 122 stations in 1996, of which 73 did not catch Yelloweye Rockfish (red open circles), 47 stations did catch it (red closed circles), and 2 were deemed unusable by the IPHC (grey closed circles) and so are not considered further. The black line indicates the geographic cut-off, below which stations are excluded when constructing Series~A and~B; for this year no stations (black crosses) are excluded.}{stations1996mapA}{5}


% Start of maps from iphcSerA20hooksYYR.tex
\onefig{stations1997mapAkeep}{Locations of the 122 stations in 1997, of which 80 did not catch Yelloweye Rockfish (red open circles), 41 stations did catch it (red closed circles), and 1 was deemed unusable by the IPHC (grey closed circles) and so are not considered further. The black line indicates the geographic cut-off, below which stations are excluded when constructing Series~A and~B; for this year no stations (black crosses) are excluded.}{stations1997mapAkeep}{5}


\onefig{stations1998mapAkeep}{Locations of the 128 stations in 1998, of which 84 did not catch Yelloweye Rockfish (red open circles), 44 stations did catch it (red closed circles), and 0 were deemed unusable by the IPHC (grey closed circles) and so are not considered further. There are no black crosses because no stations are being excluded from Series~A.}{stations1998mapAkeep}{5}
  


\onefig{stations1999mapAkeep}{Locations of the 170 stations in 1999, of which 107 did not catch Yelloweye Rockfish (red open circles), 61 stations did catch it (red closed circles), and 2 were deemed unusable by the IPHC (grey closed circles) and so are not considered further. Black crosses indicate the 35 stations being excluded from Series~A because they lie south of the geographic cut-off shown on Figure~\ref{fig:stations1995mapA}.}{stations1999mapAkeep}{5}



\onefig{stations2000mapAkeep}{Locations of the 129 stations in 2000, of which 83 did not catch Yelloweye Rockfish (red open circles), 46 stations did catch it (red closed circles), and 0 were deemed unusable by the IPHC (grey closed circles) and so are not considered further. There are no black crosses because no stations are being excluded from Series~A.}{stations2000mapAkeep}{5}



\onefig{stations2001mapAkeep}{Locations of the 170 stations in 2001, of which 120 did not catch Yelloweye Rockfish (red open circles), 50 stations did catch it (red closed circles), and 0 were deemed unusable by the IPHC (grey closed circles) and so are not considered further. Black crosses indicate the 35 stations being excluded from Series~A.}{stations2001mapAkeep}{5}



\onefig{stations2002mapAkeep}{Locations of the 170 stations in 2002, of which 130 did not catch Yelloweye Rockfish (red open circles), 40 stations did catch it (red closed circles), and 0 were deemed unusable by the IPHC (grey closed circles) and so are not considered further. Black crosses indicate the 35 stations being excluded from Series~A.}{stations2002mapAkeep}{5}

% Don't need this as covered in allBlocks0314map
% \onefig{all2003mapAkeep20}{Locations of all 170 stations for the IPHC survey for 2003 onwards. There are 83 stations that never caught Yelloweye Rockfish (blue open circles) in the first 20 hooks, and 87 stations that did catch it at least once in the first 20 hooks. Black crosses indicate the 35 stations being excluded from Series~A.}{stations2003mapAkeep}{5}   % $ 
% End of maps from iphcSerA20hooksYYR.tex, though 2013 one below is also from there

% From iphcSerBallHooksYYR.tex
\onefig{all2003mapAkeep}{Locations of all 170 stations for the IPHC survey for 2003 onwards. There are 59 stations that never caught Yelloweye Rockfish (blue open circles), and 111 stations that did catch it at least once. Black crosses indicate the 35 stations being excluded from Series~A and Series~B.}{all2003mapAkeep}{5}   % $ 


% From iphcCombineAB-YYR.ps - not quite sure where it's made.
\onefig{allBlocks0314map}{Locations of all 170 stations for the IPHC survey for 2003-2012 and 2014. There are 59 stations that never caught Yelloweye Rockfish (blue open circles), 24 stations that caught Yelloweye Rockfish but never in the first 20 hooks (red closed circles), and 87 that did catch Yelloweye Rockfish within the first 20 hooks (blue closed circles). Black crosses indicate the 35 stations being excluded from Series~A and~B.}{allBlocks0314map}{5}   % Could add in 2013, but probably not since it cannot add any red circles.

% Also from iphcSerA20hooksYYR.tex
\onefig{stations2013mapAkeep}{Locations of the 170 stations in 2013, of which 134 did not catch Yelloweye Rockfish (red open circles), 36 stations did catch it (red closed circles), and 0 were deemed unusable by the IPHC (grey closed circles) and so are not considered further. Black crosses indicate the 35 stations being excluded from Series~A.}{stations2013mapAkeep}{5} % The black line indicates the latitude below which stations are being excluded.}
