...
% Title
\newcommand{\rdTitle}{A Data Synopsis Report for British Columia Groundfish}

% Author names separated by commas and ', and' for the last author in the format 'M.H. Grinnell' (use \textsuperscript{n} for addresses)
\newcommand{\rdAuth}{S.C. Anderson\textsuperscript{1}, E.A.
Keppel\textsuperscript{1}, A.A. Other Possible Authors Here}

% Author names reversed separated by commas in the format 'Grinnell, M.H.'
\newcommand{\rdAuthRev}{Anderson, S.C., Keppel, E.A., Other, A.A}
...
\newcommand{\rdAbstract}{\Sexpr{knit_child('doc/00-abstract.Rnw')}}
...
<<variables, child='doc/99-variables.Rnw'>>=
@
...
<<introduction, child='doc/01-introduction.Rnw'>>=
@
...
This section contains of the main species-by-species data visualizations. Each
...
according to DFO species codes, which are the page numbers in \citet{hart1988}.
...
<<models, child='doc/modelling.Rnw'>>=
@

\clearpage

\bibliography{spp-refs,synopsis}
