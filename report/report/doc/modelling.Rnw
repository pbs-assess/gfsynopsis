...
equations below unwritten the methods in the first person for clarity.
...
<<load-cpue-model>>=
cpue_model <- readRDS("../../cpue-cache/petrale-sole-3[CD]+-model.rds")
@
...
gfplot::plot_cpue_index_coefs(cpue_model, regex = c(", base_[a-z]+", ""))
@
