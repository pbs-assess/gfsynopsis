...
\item Synoptic Survey, Queen Charlotte Sound (SYN WCHG):  \citep{williams2018synqcs}

\item Synoptic Survey, West Coast Vancouver Island (SYN WCVI):
  \citep{williams2017synwcvi}

\item Synoptic Survey, Hecate Strait (SYN HS): \citep{nottingham2018synhs}

\item Synoptic Survey, West Coast Haida Gwaii (SYN WCHG):
  \citep{nottingham2018synwchg}
