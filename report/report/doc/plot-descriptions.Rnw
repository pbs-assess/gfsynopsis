...
We model the expected biomass density in space for each species using data from the synoptic bottom trawl surveys, the Outer Hard Bottom Long Line surveys (alternatively referred to as the, Pacific Halibut Management Association, PHMA, surveys), and the International Pacific Halibut Commission (IPHC) surveys.
