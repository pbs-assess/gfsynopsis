...
Haggarty, Andrew Edwards, Chris Grandin, and Rob Kronlund for invaluable input
into the report design and feedback throughout its production. We thank Norm
Olsen, Maria Surry, and Malcolm Wyeth for providing support on data extraction
and general database structure and content. We thank Christie Whelan for her
support initiating this project. Finally, we are grateful for the ongoing
collaboration with commercial fishermen, First Nations, and non-governmental
organizations, which has made the collection of the valuable data that underlies
