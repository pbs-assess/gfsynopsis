...
we have focused on the A-level species, which are identified as the main species
of commercial and conservation interest. The strategic plan also includes a set
of B-level species, which could easily be included as well.
...
DFO species code, which usually corresponds to the page number referencing the species in
