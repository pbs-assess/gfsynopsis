...
We used the model-based approach described here without documentation of the methodological change in the 2023-data update version [@synopsis2023data].
...
This grid definition includes some cells that are now part of the frozen trawl footprint. 
