...
# dat_survey_index <- gfdata::design_indexes |> dplyr::filter(species_common_name == "canary rockfish")
# survs <- c(
...
surv_abbrev_text <- "SYN WCHG = West Coast Haida Gwaii Synoptic Bottom Trawl, SYN HS = Hecate Strait Synoptic Bottom Trawl, SYN QCS = Queen Charlotte Sound Synoptic Bottom Trawl, SYN WCVI = West Coast Vancouver Island Synoptic Bottom Trawl, HBLL OUT N = Hard Bottom Longline Outside North, HBLL OUT S = Hard Bottom Longline Outside South, HBLL INS N = Hard Bottom Longline Inside North, HBLL INS S = Hard Bottom Longline Inside South, IPHC FISS = International Pacific Halibut Commission Fishery-Independent Setline Survey, MSA HS = Hecate Strait Multispecies Assemblage Bottom Trawl, MSSM WCVI = West Coast Vancouver Island Multispecies Small-mesh Bottom Trawl"
```
