...
* We added text describing triggers (or "exceptional circumstances") for potential early reassesment for those stocks where a quantitative trigger was stated in the latest Science Advisory Report or Science Response. In this report, we added such text for Dover Sole and Silvergray Rockfish and evaluate each stock against the stated triggers.
* We added a web version of the report at <https://gfsynopsis.ca>. The web version should render appropriately on laptop or desktop screens as well as mobile devices. We encourage users to use whichever version is most convenient to them, but to cite this latest Technical Report as well as one or both of @anderson2019synopsis and @anderson2020fisheries. 
