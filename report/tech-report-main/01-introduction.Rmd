...
Versions with 2022 and 2023 data were published as Technical Reports (TODO).
...
In this report, all figure pages were rebuilt with updated data using the methods described in @anderson2019synopsis, @anderson2020fisheries, @synopsis2021data, @synopsis2022data, and @synopsis2023data.

Additionally:

* We updated the recent references at the top of each species page.

* We updated the commercial catch-per-unit-effort (CPUE) standardization to use a spatiotemporal model (Appendix \@ref(app:iphc)).
