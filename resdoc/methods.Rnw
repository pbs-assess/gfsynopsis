...
sector since 2012 when the trawl footprint was implemented (Table~\ref{tab:sql-cpue-spatial}). Spatial longline
...
survey and commercial data, each filtered by the \texttt{TRIP\_SUBTYPE\_CODE} for either
