...
Lines 9-11  Our implementation **consists of two pages per species that** ~~includes~~ **show** standardized visualizations of temporal trends and spatial distributions of commercial catches and survey indices, ~~plus~~ **along with** analyses of age~~s~~, ~~lengths~~**size**, maturity, and growth~~, all on two pages per species~~.
