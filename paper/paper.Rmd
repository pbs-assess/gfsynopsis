...
Modern survey and fishery observation programs generate vast quantities of data; however, translating that data into effective monitoring remains a challenge. In British Columbia, Canada, survey and commercial observation programs produce data on over 200 groundfish species, but the majority of such data remain unreported. Here, we describe an automated report for 113 groundfish species in Pacific Canadian waters to encourage others to consider similar reports for their own data. Our report includes standardized visualizations of commercial and survey population trends in time and space, age and length frequencies, maturity, and growth. The report facilitates discussions on stock-assessment and survey prioritization, increases transparency about data holdings, and makes the data available for regular review by all interested parties.
  
\clearpage

# Introduction

Modern survey and fishery observation programs generate vast quantities of biological and environmental data;
...
agencies, are now made available [e.g., @obama2013;
...
most of these species, and are not available every year for most that are assessed, limiting the
...
liken our report to window shopping (Ricard, personal communication, 2018). Our report gives a quick flavour of the
...
species and there are many reasons why commercial CPUE may not reflect abundance [e.g., @harley2001].
...
groundfish scientists has been positive [@dfo2019synopsis]. Internally, the report has become an
...
Figure \@ref(fig:page1): Example first page for rougheye/blackspotted rockfish complex
...
Figure \@ref(fig:page2): Example second page for rougheye/blackspotted rockfish complex
