...
<!-- Can we say "raw" data here and throughout the paper given the modelling done for the spatial data? -->
Keywords:
...
<!-- EK: I like starting with the goals here. If we're trying to focus more on the 'approach' than our specific 'report',
for the methods section would it make sense to next follow the data to document workflow instead of leading with our report layout? I can take a stab at reorganizing this section if that makes sense. -->
