---
title: |
  A reproducible data synopsis report for over 100 species facilitates indicator monitoring, data transparency, and prioritization discussions\\ 
  Reproducible data synopsis reports facilitate indicator monitoring, data transparency, and prioritization discussions\\
...
We have described an automated report that presents up-to-date population trends and biological data from both commercial fisheries and DFO multi-species research surveys for groundfish in British Columbia, Canada. Stock assessments are not available for most of these species, or in all years for those that are assessed, limiting the dissemination of these data. Our report facilitates the broad monitoring of groundfish populations in British Columbia waters. It ensures all B.C. groundfish scientists, managers, and interested parties have easy access to consistent and easily digestible visualizations of current data holdings. This increases transparency, ensures relevant parties are regularly reviewing data for indications of surprises, and facilitates discussions concerning stock assessment and survey program prioritization.
