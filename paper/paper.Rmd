...
- limit ourselves to two pages per species so that we can look at all data for one species at once
- highlight uncertainty wherever possible
- assemble and display metadata alongside visualization
- maintain consistent colour meaning throughout and make it colourblind proof where possible
...
How we did it:
- develop a family of R packages that facilitate going directly from our relational databases, to extracting necessary data, to tidying the necessary data, to fitting statistical models, and to visualizing the data and statistical models in a report format
