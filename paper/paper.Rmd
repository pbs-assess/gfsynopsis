...
header-includes:
    ...
    - \usepackage[left]{lineno}\linenumbers\modulolinenumbers[2]
...
In British Columbia (BC), Canada, Fisheries and Oceans Canada (DFO) faces these very problems in monitoring its groundfish populations and fisheries. Government groundfish scientists hold the potential responsibility of providing science advice on over 100 species. The commercial groundfish fleet is subject to 100% on-board and dockside monitoring and numerous fisheries-independent trawl and longline surveys are conducted annually producing large quantities of valuable data. At the same time, assessment scientists face limitations in personnel and time. As a result, most stocks are not regularly examined through stock assessment leaving the majority of monitoring data unreported. And, although the Canadian government is engaged in an open-data initiative, some of DFO's data holdings will never be shared due to privacy laws, and the data that are shared are not easily digested without extensive knowledge of the survey programs and commercial fishery, and advanced data processing skill sets.

Automated visualization is a solution to these problems. Rather than just being an endpoint to data analysis, there is an increasing realization that visualization should be an "integral part of the scientific process" [@fox2011].
...
1. facilitating discussions related to stock assessment prioritization (e.g. quick look at status, trends or lack of data requiring rapid attention) and survey programs (e.g. display of available data and any data gaps that may require survey focus),
1. increasing transparency about our data holdings, and
1. producing standardized tools, derived data sets, and visualizations that are useful elsewhere in, for example, assessments.
