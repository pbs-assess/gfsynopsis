...
Such an approach facilitates new research ideas, such as: Why did a species index trend change? What correlations might exist between biological trends and population? Are there relationships between fishery trends before and after management changes? and addresses questions such as:
...
Figure 4: Workflow. A: Illustration of the data-to-document workflow. B: Families of modular functions built and employed to ensure transparency, traceability, and reproduciblity.
