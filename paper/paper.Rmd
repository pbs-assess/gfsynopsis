...
The report includes two pages of visualization for 113 stocks of British Columbia groundfish and sharks including XX species of rockfish, ... etc. (Figs 1 and 2). The first page for each species features metadata and temporal and spatial trends and patterns from fisheries independent surveys and commercial catch and effort data. Specifically, it includes:
...
Although not shown here, the visualizations for many stocks include mostly empty plots emphasizing species for which there remain many unknown unknowns. In other cases, nearly all the data available for data-rich stocks are visualized together on two pages for the first time.
