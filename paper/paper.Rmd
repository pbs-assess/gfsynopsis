...
The report includes two pages of visualization for 113 species [TODO it
originally said stocks, but
the list below adds up to 113 species; I changed later ones also --- just wanted
to flag it] of British
...
The visualizations for many data-poor species include mostly empty plots, which
graphically demonstrates the lack of data (and hence knowledge) for such species.
For data-rich species, nearly
all the data available are visualized together on two pages
for the first time.
