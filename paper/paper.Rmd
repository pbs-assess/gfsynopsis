...
1. Reproducible and transparent presentation of monitoring data:
     an example with over 100 Pacific Canadian groundfish species.
...
(1) ensuring that the current state of knowledge on indices of population status
...
caught in DFO surveys. We included both commercial and survey population trends
and biological data in the report to give an overall snapshot of available
...
and taxonomic coverage of the species in the report. We chose to focus on
