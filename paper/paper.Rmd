...
It is challenging to meaningfully report on the voluminous data
collected by survey and fishery-observation programs. Consequently, the
data's monitoring potential is not fully realised.
Here, we describe an automated report for 113 groundfish species in
...
maturity, and growth. It facilitates discussions on stock-assessment and
survey prioritization, increases transparency about data holdings, and makes the
data available for regular review by interested parties.
