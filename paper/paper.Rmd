...
essential to detecting ecological surprises and "unknown unknowns" [e.g.,
@hilborn1987; @wintle2010]. As part of a movement towards open data, many raw
data sets, including those collected by government agencies, are now made
available [e.g., @obama2013;
...
such species. For data-rich species, nearly all data available are
...
certain species and there are many reasons why commercial CPUE may not reflect
abundance [e.g., @harley2001].
