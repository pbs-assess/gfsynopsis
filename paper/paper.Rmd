...
To address this gap, here we make the case for multi-species consistent-format visualization of raw fisheries data. We demonstrate the concept through a report focussing on 113 groundfish species on the west coast of Canada [@anderson2019synopsis].
...
knitr::kable(
  ...
  kableExtra::column_spec(1, width = "6.2cm") %>%
  kableExtra::column_spec(2, width = "9.7cm")
```
