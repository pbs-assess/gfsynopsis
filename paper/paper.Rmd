...
automated data synopsis report for 113 groundfish species in BC,
...
to flag it] of BC
groundfish and sharks. Figures 1 and 2 show the pages for an example
...
(in particular as documented R packages), we are cautiously optimistic that
it will not be overly onerous to maintain the code and to produce frequent updates
...
in a recent Pacific cod assessment for the coast of BC
